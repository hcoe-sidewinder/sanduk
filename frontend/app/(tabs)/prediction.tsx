...
const FamilyMemberCard: React.FC<FamilyMemberCardProps> = ({
  ...
  const hasHighRiskConditions = member.conditions.some(
    (condition: string) => diseaseInfo[condition]?.severity >= 4
  );
          ...
          >
            ...
            >
              <Text style={styles.disclaimerIcon}>
                <Text style={styles.disclaimerLegend}>HRD</Text>Heart Disease
              </Text>
              <br />
              <Text style={styles.disclaimerIcon}>
                <Text style={styles.disclaimerLegend}>DBT</Text>Diabetes
              </Text>
              <br />
              <Text style={styles.disclaimerIcon}>
                <Text style={styles.disclaimerLegend}>CNC</Text>Cancer
              </Text>
              <br />
              <Text style={styles.disclaimerIcon}>
                <Text style={styles.disclaimerLegend}>HTN</Text>Hypertension
              </Text>
              <br />
              <Text style={styles.disclaimerIcon}>
                <Text style={styles.disclaimerLegend}>ALZ</Text>Alzheimers
              </Text>
              <br />
              <Text style={styles.disclaimerIcon}>
                <Text style={styles.disclaimerLegend}>STK</Text>StrokE
              </Text>
              <br />
              <Text style={styles.disclaimerIcon}>
                <Text style={styles.disclaimerLegend}>ART</Text>Arthritis
              </Text>
              <br />
              <Text style={styles.disclaimerIcon}>
                <Text style={styles.disclaimerLegend}>OST</Text>Osteoporosis
              </Text>
              <br />
              <Text style={styles.disclaimerIcon}>
                <Text style={styles.disclaimerLegend}>KDD</Text>Kidney Disease
              </Text>
              <br />
              <Text style={styles.disclaimerIcon}>
                <Text style={styles.disclaimerLegend}>DPN</Text> Depression
              </Text>
              <br />
              <Text style={styles.disclaimerIcon}>
                <Text style={styles.disclaimerLegend}>OBS</Text>Obesity
              </Text>
              <br />
              <Text style={styles.disclaimerIcon}>
                <Text style={styles.disclaimerLegend}>PKN</Text>Parkinsons
              </Text>
              <br />
            </Text>
          </View>
